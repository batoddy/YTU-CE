...
INSERT INTO student VALUES(200, 'Ayşe', 'Can');
...
--kayıt güncelleme:
UPDATE student SET firstname='Veli'  WHERE stdNo=134

--student tablosunda ismi Ahmet olan kayıtları siliniz.
DELETE FROM student WHERE firstname='Ahmet'
...
--öğrenci numarası 104 ile 200 arasında olan öğrencileri listele:
SELECT *
FROM student
WHERE 104<stdNo AND stdNo<200
...
SELECT *
FROM student
WHERE stdNo BETWEEN 104 AND 200
