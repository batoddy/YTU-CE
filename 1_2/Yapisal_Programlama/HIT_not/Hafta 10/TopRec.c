#include <stdio.h>
int TopRecurse(int a, int b) // iki pozitif sayiyi toplar, sayilar negatif olursa nas�l cozeriz?
{
	if (b == 0)
		return a;
	else
...
int ElemanAraRecurse(int *dizi, int b, int x) // bir dizide eleman arayalim
{
	if (b < 0)
		return -1;
	else if (dizi[b] == x)
